...
struct API {
    ...
    static func getRestaurants(completion: @escaping ([Restaurant]?) -> Void) {
        ...
        let apikey = "VynlZqhP2-BJpHENbEJY_7viotxN2ymQ_Y7ya_zU8E5tRlZsWASdJ54sOHJckbvLWJjBd_0BDHnijBIPRwvR0OaMNnGezDtQpBT8kzpHwvYvzeWw7MrD8CtvAZ39YHYx"
        ...
        let task = session.dataTask(with: request) { (data, response, error) in
            ...
            if let error = error {
                ...
                for dictionary in restaurants {
                    let r = Restaurant.init(dict: dictionary)
                    restaurantList.append(r) // add to restaurants array
                }
